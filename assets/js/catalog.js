 ...
 *            Tout est 'public' pour l'instant. Le mécanisme reste en place
 *            (cartes, filtres, garde de page) pour le jour où une partie du
 *            catalogue repassera derrière un compte ou un abonnement.
...
(function (global) {
  ...
  GRENIER.newestIds = [
    'athenes', 'rome-antique', 'el-jem', 'sudoku', 'mots-fleches', 'mots-croises', 'roue-des-defis', 'france', 'tunisie', 'empires', 'anatomie', 'planetes', 'volcans', 'electricite', 'marie-curie', 'corps-humain',
  ...
  GRENIER.items = [
    ...
    { id: 'haroun', title: 'Haroun', emoji: '🗣️', cat: 'propheties', kind: 'histoire',
      dir: 'stories/religion', file: 'haroun.html', age: 7, access: 'public',
    ...
    { id: 'soulayman', title: 'Soulayman', emoji: '👑', cat: 'propheties', kind: 'histoire',
      dir: 'stories/religion', file: 'soulayman.html', age: 7, access: 'public',
    ...
    { id: 'dawud', title: 'Dawud', emoji: '🎵', cat: 'propheties', kind: 'histoire',
      dir: 'stories/religion', file: 'dawud.html', age: 7, access: 'public',
    ...
    { id: 'ilyes', title: 'Ilyès', emoji: '⚡', cat: 'propheties', kind: 'histoire',
      dir: 'stories/religion', file: 'ilyes.html', age: 10, access: 'public',
    ...
    { id: 'haroun-rachid', title: 'Haroun al-Rachid', emoji: '🏛️', cat: 'propheties', kind: 'histoire',
      dir: 'stories/religion', file: 'haroun_rachid.html', age: 10, access: 'public',
    ...
    { id: 'omar', title: 'Omar ibn al-Khattab', emoji: '⚖️', cat: 'propheties', kind: 'histoire',
      dir: 'stories/religion', file: 'omar.html', age: 10, access: 'public',
    ...
    { id: 'lumiere-hira', title: 'La Lumière de Hira', emoji: '🌙', cat: 'propheties', kind: 'histoire',
      dir: 'stories/religion', file: 'la-lumiere-de-hira.html', age: 10, access: 'public',
    ...
    { id: 'squirrel', title: 'السنجاب الصغير', emoji: '🐿️', cat: 'arabe', kind: 'histoire',
      dir: 'stories/arabe', file: 'squirrel.html', age: 4, access: 'public',
    ...
    { id: 'samsoum', title: 'سمسوم والجسر المكسور', emoji: '🐰', cat: 'arabe', kind: 'histoire',
      dir: 'stories/arabe', file: 'samsoum.html', age: 4, access: 'public',
    ...
    { id: 'colomb', title: 'Christophe Colomb', emoji: '⛵', cat: 'legendes', kind: 'histoire',
      dir: 'stories/legend', file: 'colomb.html', age: 10, access: 'public',
    ...
    { id: 'ibn-battuta', title: 'Ibn Battuta', emoji: '🧭', cat: 'legendes', kind: 'histoire',
      dir: 'stories/legend', file: 'ibn-battuta.html', age: 10, access: 'public',
    ...
    { id: 'phare', title: 'Le Phare des Marées Perdues', emoji: '🕯️', cat: 'sciences', kind: 'histoire',
      dir: 'stories/science', file: 'phare.html', age: 7, access: 'public',
    ...
    { id: 'lumiere', title: 'La Lumière qui Voyageait', emoji: '🔭', cat: 'sciences', kind: 'histoire',
      dir: 'stories/science', file: 'lumiere.html', age: 7, access: 'public',
    ...
    { id: 'simon-game', title: 'Simon Dit', emoji: '🎵', cat: 'jeux', kind: 'jeu',
      dir: 'games', file: 'simon-game.html', age: 7, access: 'public',
    ...
    { id: 'mots-fleches', title: 'Mots Fléchés', emoji: '➡️', cat: 'jeux', kind: 'jeu',
    ...
    { id: 'anatomie', title: 'L\'Explorateur du Corps Humain', emoji: '🫁', cat: 'sciences', kind: 'outil',
      dir: '.', file: 'anatomie.html', age: 7, access: 'public',
      desc: 'Un corps en trois dimensions à faire tourner et à traverser du regard : dix-sept organes à toucher du doigt, leurs chiffres, leurs secrets — et un jeu pour les retrouver.',
      tags: ['corps', 'anatomie', 'organes', 'coeur', 'cerveau', 'poumons', 'squelette', 'sciences', '3d'] },
